...
public class CameraFollow : MonoBehaviour 
{
	...
	void TrackPlayer ()
	{
		...
		float targetZ = this.transform.position.y;
		...
		if(CheckYMargin())
			...
			targetZ = Mathf.Lerp(this.transform.position.z, player.position.z, zSmooth * Time.deltaTime);
		...
		this.transform.position = new Vector3(targetX, targetZ, transform.position.z );
	}
}
